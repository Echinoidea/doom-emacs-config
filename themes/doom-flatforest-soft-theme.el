;;; doom-flatforest-soft-theme.el --- Everforest light with flatwhite-style highlighting -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;
;;; Commentary:
;; Everforest light soft theme with flatwhite-style colored backgrounds for syntax highlighting
;;
;;; Code:
...
(defgroup doom-flatforest-soft-theme nil
  "Options for the `doom-flatforest-soft' theme."
  :group 'doom-themes)

(defcustom doom-flatforest-soft-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-flatforest-soft-theme
  :type 'boolean)

(defcustom doom-flatforest-soft-no-highlight-variables nil
  "If non-nil, removes highlight on variable names"
  :group 'doom-flatforest-soft-theme
  :type 'boolean)

(defcustom doom-flatforest-soft-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-flatforest-soft
    "A minimal light syntax theme with Everforest colors and flatwhite-style highlighting"

  ;; name        default   256       16
  (
   ;; Everforest light soft palette
   (ef-bg-dim     '("#e5dfc5" "white"   "white"  ))
   (ef-bg0        '("#f3ead3" "white"   "white"  ))
   (ef-bg1        '("#eae4ca" "white"   "white"  ))
   (ef-bg2        '("#e5dfc5" "grey"    "grey"   ))
   (ef-bg3        '("#ddd8be" "grey"    "grey"   ))
   (ef-bg4        '("#d8d3ba" "grey"    "grey"   ))
   (ef-bg5        '("#b9c0ab" "grey"    "grey"   ))
   (ef-bg-red     '("#fadbd0" "red"     "red"    ))
   (ef-bg-yellow  '("#f1e4c5" "yellow"  "yellow" ))
   (ef-bg-blue    '("#e5e6c5" "blue"    "blue"   ))
   (ef-bg-purple  '("#f1ddd4" "magenta" "magenta"))
   (ef-bg-visual  '("#e1e4bd" "cyan"    "cyan"   ))
   ...
   ;; custom categories
   (-modeline-bright doom-flatforest-soft-brighter-modeline)
   (-no-highlight-variables doom-flatforest-soft-no-highlight-variables)
   (-modeline-pad
    (when doom-flatforest-soft-padded-modeline
      (if (integerp doom-flatforest-soft-padded-modeline) doom-flatforest-soft-padded-modeline 4)))
  ...
  ((font-lock-builtin-face :inherit 'italic :foreground fg :extend t)
   ...
   (org-document-title :foreground ef-blue :background ef-blue-blend :weight 'bold :slant 'italic)
   (org-level-1 :foreground ef-red :background ef-red-blend :weight 'bold)
   (org-level-2 :foreground ef-orange :background ef-orange-blend :weight 'bold)
   (org-level-3 :foreground ef-yellow :background ef-yellow-blend :weight 'bold)
   (org-level-4 :foreground ef-green :background ef-green-blend :weight 'bold)
   (org-level-5 :foreground ef-aqua :background ef-aqua-blend :weight 'bold)
   (org-level-6 :foreground ef-blue :background ef-blue-blend :weight 'bold)
   (org-level-7 :foreground ef-purple :background ef-purple-blend :weight 'bold)
   (org-level-8 :foreground ef-red :background ef-red-blend :weight 'bold)
   ;;;; racket
...
;;; doom-flatforest-soft-theme.el ends here
