...
;;   :config
;;   (require 'auth-source)
;;   (let ((auth-token (auth-source-pick-first-password :host "api.anthropic.com" :user "apikey")))
;;     (when auth-token
;;       (setq gptel-api-key auth-token))))

;; (after! gptel
;;   (setq gptel-model 'claude))
...
(gptel-make-anthropic "Claude"          ;Any name you want
  ...
  :key "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")
