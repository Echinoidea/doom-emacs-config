...
(doom! :input
       ...
       :tools
       ;;ansible
       ;; (biblio +vertico)            ; Writes a PhD for you (citation needed)
       ...
       (org +roam +journal +brain +contacts +passwords +pomodoro)              ; organize your plain life in plain text
       ...
       :config
       ;; For literate programming doom configs
       ;; literate
