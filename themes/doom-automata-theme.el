;;; doom-automata-theme.el --- A port of Sainnhe's everforest-hard theme; -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-automata-theme nil
  "Options for doom-automata."
  :group 'doom-themes)

(defcustom doom-automata-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-automata-theme
  :type 'boolean)

(defcustom doom-automata-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-automata
                ...
                ((bg         '("#1e2326" "#1e2326" nil          )) ; bg1
                 ...
                 (selection      bg-alt2)
                 (builtin        orange)
                 (comments       (if doom-automata-brighter-comments magenta grey))
                 (doc-comments   (if doom-automata-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
                 (constants      violet)
                 (functions      cyan)
                 (keywords       red)
                 (methods        cyan)
                 ...
                 ;; custom categories
                 (-modeline-pad
                  (when doom-automata-padded-modeline
                    (if (integerp doom-automata-padded-modeline)
                        doom-automata-padded-modeline
                      4)))
...
;;; doom-automata-theme.el ends here
