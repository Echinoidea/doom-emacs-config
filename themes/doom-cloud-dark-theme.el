...
;;; doom-cloud-dark-theme.el --- Evening Clouds Doom Emacs theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-cloud-dark-theme nil
  "Options for the `doom-cloud-dark' theme."
  :group 'doom-themes)

(defcustom doom-cloud-dark-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-cloud-dark-theme
  :type 'boolean)

(defcustom doom-cloud-dark-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-cloud-dark-theme
  :type 'boolean)

(defcustom doom-cloud-dark-comment-bg doom-cloud-dark-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-cloud-dark-theme
  :type 'boolean)

(defcustom doom-cloud-dark-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-cloud-dark
    "A dark theme inspired by Rose Pine"
  :family 'doom-cloud-dark
  ...
  (
   ...
   (rp-highlight-low  '("#26233a" "grey" "grey"))
   (rp-highlight-med  '("#37354d" "grey" "grey"))
   (rp-highlight-high '("#44425b" "grey" "grey"))
   ...
   (selection      nil)
   (builtin        rp-foam)
   (comments       (if doom-cloud-dark-brighter-comments rp-pine rp-muted))
   (doc-comments   (doom-lighten (if doom-cloud-dark-brighter-comments rp-pine rp-muted) 0.25))
   (constants      rp-iris)
   (functions      rp-rose)
   (keywords       rp-pine)
   (methods        rp-foam)
   ...
   ;; custom categories
   (hidden     (car bg))
   (-modeline-bright doom-cloud-dark-brighter-modeline)
   (-modeline-pad
    (when doom-cloud-dark-padded-modeline
      (if (integerp doom-cloud-dark-padded-modeline) doom-cloud-dark-padded-modeline 4)))
  ...
  ((hl-line :background rp-highlight-low)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-cloud-dark-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
...
;;; doom-cloud-dark-theme.el ends here
