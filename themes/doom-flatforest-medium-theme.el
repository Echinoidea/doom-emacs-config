;;; doom-flatforest-medium-theme.el --- Everforest light with flatwhite-style highlighting -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;
;;; Commentary:
;; Everforest light medium theme with flatwhite-style colored backgrounds for syntax highlighting
;;
;;; Code:
...
(defgroup doom-flatforest-medium-theme nil
  "Options for the `doom-flatforest-medium' theme."
  :group 'doom-themes)

(defcustom doom-flatforest-medium-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-flatforest-medium-theme
  :type 'boolean)

(defcustom doom-flatforest-medium-no-highlight-variables nil
  "If non-nil, removes highlight on variable names"
  :group 'doom-flatforest-medium-theme
  :type 'boolean)

(defcustom doom-flatforest-medium-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-flatforest-medium
    "A minimal light syntax theme with Everforest colors and flatwhite-style highlighting"

  ;; name        default   256       16
  (
   ;; Everforest light medium palette
   (ef-bg-dim     '("#efebd4" "white"   "white"  ))
   (ef-bg0        '("#fdf6e3" "white"   "white"  ))
   (ef-bg1        '("#f4f0d9" "white"   "white"  ))
   (ef-bg2        '("#efebd4" "grey"    "grey"   ))
   (ef-bg3        '("#e6e2cc" "grey"    "grey"   ))
   (ef-bg4        '("#e0dcc7" "grey"    "grey"   ))
   (ef-bg5        '("#bdc3af" "grey"    "grey"   ))
   (ef-bg-red     '("#fde3da" "red"     "red"    ))
   (ef-bg-yellow  '("#faedcd" "yellow"  "yellow" ))
   (ef-bg-blue    '("#e9f0e9" "blue"    "blue"   ))
   (ef-bg-purple  '("#fae8e2" "magenta" "magenta"))
   (ef-bg-visual  '("#eaedc8" "cyan"    "cyan"   ))
   ...
   ;; custom categories
   (-modeline-bright doom-flatforest-medium-brighter-modeline)
   (-no-highlight-variables doom-flatforest-medium-no-highlight-variables)
   (-modeline-pad
    (when doom-flatforest-medium-padded-modeline
      (if (integerp doom-flatforest-medium-padded-modeline) doom-flatforest-medium-padded-modeline 4)))
...
;;; doom-flatforest-medium-theme.el ends here
